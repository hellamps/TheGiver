...
var RotateFile = function(options) {
	...
	this.log_directory = options.log_directory;
};
...
RotateFile.prototype.open = function(callback) {
	...
	if (this.opening) {
		...
		if (this.symlink) {
			var symlink = this.log_directory + '/' + this.symlink;
...
RotateFile.prototype._getFile = function() {
	...
	if (!filename.match(/^\//)) {
		filename = this.log_directory + '/' + filename;
	}
	this.dirname = '/';
...
function logger(options) {
	...
	this.level = winston_logger.level;
